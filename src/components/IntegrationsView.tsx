        ...
        <div className="bg-hub-card rounded-2xl border border-hub-border p-5">
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-[#EA4B71]/10 flex items-center justify-center">
              ...
              {rules.map((rule, idx) => (
                ...
                >
                  <td className="px-5 py-3">
                    <span className="text-hub-text text-xs font-medium">
                      {rule.channel === "Zendesk" && "🎫 "}
                      {rule.channel === "Email" && "📧 "}
                      {rule.channel === "Axiskey" && "🏛️ "}
                      {rule.channel === "Any" && "🔀 "}
                      {rule.channel}
                    </span>
                  </td>
